...
// a dictionary with insertText as key and the d3fend data as value
export const D3FEND_DATA = COMPLETION_DATA.reduce((acc: { [key: string]: typeof item }, item: { insertText: string }) => {
    acc[item.insertText as string] = item;
    return acc;
}, {});